...
public class SendEmailGmailSMTP {
    ...
    final static private String gmailusername = "Group3SWE335@gmail.com";
    final static private String gmailpassword = "Group32020!";

    public static void main(String[] args) {
        // -- comma separated values of to email addresses
        String to = "brianchung@callutheran.edu";
        sendMail(to, "test");
    }
    ...
    public static void sendMail(String to, String content) {
        ...
        try {
            ...
            msg.setText("Your password is: " + content);
